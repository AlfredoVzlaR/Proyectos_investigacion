...
public class Proyectos {
    ...
    public String toString() {
        return "Proyectos{" + "id=" + id + ", codigo=" + codigo + ", nombre=" + nombre + ", acronimo=" + acronimo + ", presupuesto=" + presupuesto + ", programaInvestigacion=" + programaInvestigacion + ", desarrolloFinancia=" + desarrolloFinancia + ", fechaInicio=" + fechaInicio + ", fechaFinalizacion=" + fechaFinalizacion + ", descripcionObjetivos=" + descripcionObjetivos + ", profesores=" + profesores + '}';
    }
